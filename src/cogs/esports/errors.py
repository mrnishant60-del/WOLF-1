...
class SMError(Cog):
    ...
    async def on_tourney_registration_deny(self, message: discord.Message, _type: RegDeny, tourney: Tourney, **kwargs):
        ...
        with suppress(discord.NotFound, discord.NotFound, AttributeError, discord.HTTPException):
            ...
            if _type == RegDeny.botmention:
                ...
                await message.reply(
                    embed=self.red_embed(
                        f"{message.author.mention}, **`{plural(tourney.required_mentions):mention is |mentions are}`** required for successful registration."
                    ),
                    delete_after=5,
                )
                ...
                await message.reply(
                    embed=self.red_embed(
                        f"{message.author.mention}, You are banned from the tournament. You cannot register."
                    ),
                    delete_after=5,
                )
                ...
                await message.reply(
                    embed=self.red_embed(f"{message.author.mention}, This server doesn't allow multiple registerations."),
                    delete_after=5,
                )
                ...
                await message.reply(
                    embed=self.red_embed(f"{message.author.mention}, Team Name is required to register."),
                    delete_after=5,
                )
                ...
                await message.reply(
                    embed=self.red_embed(f"{message.author.mention}, Someone already registered with the same team name."),
                    delete_after=5,
                )
                ...
                await message.reply(
                    embed=self.red_embed(
                        f"{message.author.mention}, Your registration message is too short. It seems you missed some required information."
                    ),
                    delete_after=5,
                )
                ...
                await message.reply(
                    embed=self.red_embed(
                        f"{message.author.mention}, Someone already registered with the same mentions {jump_url}"
            ...
            elif _type == RegDeny.nologo:
                await message.reply(
                    embed=self.red_embed(
                        f"{message.author.mention}, Logo is required for registration. Please attach a team logo image."
                    ),
                    delete_after=5,
                )
                text += f"No logo attached. Logo is compulsory for registration."
    ...
    async def on_scrim_registration_deny(self, message: discord.Message, _type: RegDeny, scrim: Scrim, **kwargs):
        ...
        with suppress(discord.NotFound, discord.Forbidden, AttributeError, discord.HTTPException):
            ...
            if _type == RegDeny.botmention:
                ...
                await message.reply(
                    embed=self.red_embed(
                        f"{message.author.mention}, **`{plural(scrim.required_mentions):mention is |mentions are}`** required for successful registration."
                    ),
                    delete_after=5,
                )
                ...
                await message.reply(
                    embed=self.red_embed(f"{message.author.mention}, You are banned from the scrims. You cannot register."),
                    delete_after=5,
                )
                ...
                await message.reply(
                    embed=self.red_embed(
                        f"{message.author.mention}, Someone has already registered with the same teamname."
                    ),
                    delete_after=5,
                )
            ...
            #     await message.reply(
            #         embed = self.red_embed(
            #             f"{message.author.mention}, Your registration cannot be accepted because one your teammates is banned from scrims."
            #     ),
            #     delete_after = 5,
            #     )
